...
CREATE TABLE `Account` (
  ...
  `AcctNum` int unsigned NOT NULL,
  `AcctCreationDate` date NOT NULL,
  KEY `OwnerSSN_idx` (`OwnerSSN`),
  CONSTRAINT `OwnerSSN` FOREIGN KEY (`OwnerSSN`) REFERENCES `User` (`SSN`) ON DELETE CASCADE
...
CREATE TABLE `BlindDate` (
  `ProfileA` varchar(20) NOT NULL,
  `ProfileB` varchar(20) NOT NULL,
  `ProfileC` varchar(20) NOT NULL,
  `Date_Time` datetime NOT NULL,
  PRIMARY KEY (`ProfileA`,`ProfileB`,`ProfileC`,`Date_Time`),
  KEY `ProfileBID_idx` (`ProfileB`),
  KEY `ProfileCID_idx` (`ProfileC`),
  CONSTRAINT `ProfileAID` FOREIGN KEY (`ProfileA`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE,
  CONSTRAINT `ProfileBID` FOREIGN KEY (`ProfileB`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE,
  CONSTRAINT `ProfileCID` FOREIGN KEY (`ProfileC`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Date` (
  ...
  `CustRep` varchar(11) DEFAULT NULL,
  `Date_Time` datetime NOT NULL,
  ...
  KEY `Profile2ID_idx` (`Profile2`),
  KEY `CustRepSSN_idx` (`CustRep`),
  CONSTRAINT `CustRepSSN` FOREIGN KEY (`CustRep`) REFERENCES `Employee` (`SSN`) ON DELETE SET NULL,
  CONSTRAINT `Profile1ID` FOREIGN KEY (`Profile1`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE,
  CONSTRAINT `Profile2ID` FOREIGN KEY (`Profile2`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Date` VALUES ('Brenna_Berlin','DesiraeBerg','333-33-3333','2014-10-06 12:21:06','The Mall',36.46,'Comments Here',2,3),('Brenna_Berlin','Fletcher2013','444-44-4444','2014-09-12 23:32:33','Port Jeff Cinema',99.23,'Comments Here',4,4),('Brenna_Berlin','Isabelle2013','222-22-2222','2014-09-12 10:10:10','The Mall',20.23,'Comments Here',3,3),('DesiraeBerg','VazquezFromAlajuela','333-33-3333','2014-11-06 21:30:30','The Mall',67.39,'Comments Here',3,5),('Fletcher2013','VazquezFromAlajuela','333-33-3333','2014-10-06 04:30:52','Ruvos Restaurant',42.75,'Comments Here',3,1),('Isabelle2013','DesiraeBerg','222-22-2222','2014-10-04 21:39:42','Port Jeff Cinema',65.25,'Comments Here',4,5),('Isabelle2013','Fletcher2013','333-33-3333','2014-11-06 09:20:20','Port Jeff Cinema',139.20,'Comments Here',1,2),('Isabelle2014','VazquezFromAlajuela','222-22-2222','2014-10-06 21:49:30','The Mall',90.91,'Comments Here',3,3),('VazquezFromAlajuela','Brenna_Berlin','444-44-4444','2014-10-06 05:34:04','Turkish Restaurant',69.26,'Comments Here',4,4);
...
CREATE TABLE `Employee` (
  ...
  PRIMARY KEY (`SSN`),
  CONSTRAINT `EmployeeSSN` FOREIGN KEY (`SSN`) REFERENCES `Person` (`SSN`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Employee` VALUES ('111-11-1111','Manager','2014-10-04',250.00),('123-45-6789','Manager','2014-10-04',15.00),('123456789','Manager','2014-10-04',15.60),('222-22-2222','CustRep','2014-10-04',150.00),('333-33-3333','CustRep','2014-10-04',100.00),('444-44-4444','CustRep','2014-10-04',75.00);
...
CREATE TABLE `Likes` (
  ...
  KEY `LikeeID_idx` (`Likee`),
  CONSTRAINT `LikeeID` FOREIGN KEY (`Likee`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE,
  CONSTRAINT `LikerID` FOREIGN KEY (`Liker`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Person` VALUES ('111-11-1111','111@11','Veronica','Alvarado','45 Rockefeller Plaza','New York','New York',10111,'Fusce@velitPellentesque.net','6125062244'),('123-45-6789','123@12','Not','Piotr','Fake Address','New York','New York',12345,'fake@email.com','1234567890'),('123456789','123@12','Not','Bruh','Fake','New','New',45321,'fake@email.com','1234567890'),('222-22-2222','222@22','Bo','Osborne','45 Rockefeller Plaza','New York','New York',10111,'mattis.Integer.eu@elit.org','5927658277'),('333-33-3333','333@33','Hashim','Ross','350 5th Ave','New York','New York',10118,'vulputate@Curae.co.uk','2766346949'),('444-44-4444','444@44','Shaine','Terrell','350 5th Ave','New York','New York',10118,'tincidunt.nibh@risus.com','6008039508'),('555-55-5555','555@55','Isabelle','Odonnell','Schomburg Apartments, 350 Circle Road','Stony Brook','New York',11790,'magna.tellus.faucibus@amet.edu','9342413862'),('666-66-6666','666@66','Fletcher','Trujillo','700 Health Sciences Dr','Stony Brook','New York',11790,'elementum.dui.quis@utlacus.net','9907601480'),('777-77-7777','777@77','Malachi','Vazquez','700 Health Sciences Dr','Stony Brook','New York',11790,'tellus.lorem.eu@atlacus.org','2261938257'),('888-88-8888','888@88','Brenna','Cross','Schomburg Apartments, 350 Circle Road','Stony Brook','New York',11790,'sed.turpis@vehiculaaliquet.com','9684097641'),('999-99-9999','999@99','Desirae','Berg','116th St & Broadway','New York','New York',10027,'vitae@magnased.com','2373213189');
...
CREATE TABLE `Profile` (
  ...
  `DatingGeoRange` int DEFAULT NULL,
  ...
  KEY `ProfileSSN_idx` (`OwnerSSN`),
  CONSTRAINT `ProfileSSN` FOREIGN KEY (`OwnerSSN`) REFERENCES `User` (`SSN`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Profile` VALUES ('Brenna_Berlin','888-88-8888',18,19,21,8,'Female','Dance, Acting',6.00,180,'Blonde','2014-10-04 20:20:55','2014-10-07 12:21:58'),('DesiraeBerg','999-99-9999',20,17,25,5,'Male','Water sports, Football',5.60,200,'Red','2014-10-04 19:13:18','2014-10-04 15:54:48'),('Fletcher_Trujillo','666-66-6666',23,19,30,8,'Female','Shopping, Volleyball',5.60,150,'Brown','2014-10-04 18:26:49','2014-10-05 00:42:03'),('Fletcher2013','666-66-6666',25,20,28,18,'Female','Reading, Basketball',5.60,150,'Brown','2014-10-04 19:21:37','2014-10-07 01:25:55'),('Isabelle2013','555-55-5555',22,20,22,29,'Female','Shopping, Dance, Mountain Claiming',5.70,120,'Black','2014-10-04 00:37:12','2014-10-04 17:08:38'),('Isabelle2014','555-55-5555',22,20,25,5,'Female','Shopping, Cooking',5.70,110,'Black','2014-10-04 22:43:25','2014-10-09 11:51:19'),('VazquezFromAlajuela','777-77-7777',26,20,28,16,'Male','Hunting, Running',5.70,170,'Black','2014-10-04 17:13:30','2014-10-07 04:16:43');
...
CREATE TABLE `SuggestedBy` (
  `CustRep` varchar(11) NOT NULL,
  `Profile1` varchar(20) NOT NULL,
  `Profile2` varchar(20) NOT NULL,
  `Date_Time` datetime NOT NULL,
  PRIMARY KEY (`CustRep`,`Profile1`,`Profile2`,`Date_Time`),
  KEY `SuggestedProfile1ID_idx` (`Profile1`),
  KEY `SuggestedProfile2ID_idx` (`Profile2`),
  CONSTRAINT `CustRep` FOREIGN KEY (`CustRep`) REFERENCES `Employee` (`SSN`) ON DELETE CASCADE,
  CONSTRAINT `SuggestedProfile1ID` FOREIGN KEY (`Profile1`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE,
  CONSTRAINT `SuggestedProfile2ID` FOREIGN KEY (`Profile2`) REFERENCES `Profile` (`ProfileID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SuggestedBy` VALUES ('333-33-3333','Fletcher_Trujillo','VazquezFromAlajuela','2014-10-09 20:59:22'),('222-22-2222','Fletcher2013','DesiraeBerg','2014-10-05 15:07:44');
...
CREATE TABLE `User` (
  ...
  PRIMARY KEY (`SSN`),
  CONSTRAINT `UserSSN` FOREIGN KEY (`SSN`) REFERENCES `Person` (`SSN`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-10-26 23:51:07',NULL),('diagnostics.include_raw','OFF','2020-10-26 23:51:07',NULL),('ps_thread_trx_info.max_length','65535','2020-10-26 23:51:07',NULL),('statement_performance_analyzer.limit','100','2020-10-26 23:51:07',NULL),('statement_performance_analyzer.view',NULL,'2020-10-26 23:51:07',NULL),('statement_truncate_len','64','2020-10-26 23:51:07',NULL);
...
--
-- Temporary view structure for view `view23`
--

DROP TABLE IF EXISTS `view23`;
/*!50001 DROP VIEW IF EXISTS `view23`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view23` AS SELECT 
 1 AS `Profile1`,
 1 AS `Profile2`,
 1 AS `DT`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `view24`
--

DROP TABLE IF EXISTS `view24`;
/*!50001 DROP VIEW IF EXISTS `view24`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view24` AS SELECT 
 1 AS `Profile1`,
 1 AS `Profile2`,
 1 AS `DT`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `view25`
--

DROP TABLE IF EXISTS `view25`;
/*!50001 DROP VIEW IF EXISTS `view25`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view25` AS SELECT 
 1 AS `Profile1`,
 1 AS `Profile2`,
 1 AS `DT`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `view26`
--

DROP TABLE IF EXISTS `view26`;
/*!50001 DROP VIEW IF EXISTS `view26`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view26` AS SELECT 
 1 AS `Profile1`,
 1 AS `Profile2`,
 1 AS `DT`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `view23`
--
...
/*!50001 VIEW `view23` AS select `Date`.`Profile1` AS `Profile1`,`Date`.`Profile2` AS `Profile2`,`Date`.`Date_Time` AS `DT` from `Date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view24`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view24` AS select `Date`.`Profile1` AS `Profile1`,`Date`.`Profile2` AS `Profile2`,`Date`.`Date_Time` AS `DT` from `Date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view25`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view25` AS select `Date`.`Profile1` AS `Profile1`,`Date`.`Profile2` AS `Profile2`,`Date`.`Date_Time` AS `DT` from `Date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view26`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view26` AS select `Date`.`Profile1` AS `Profile1`,`Date`.`Profile2` AS `Profile2`,`Date`.`Date_Time` AS `DT` from `Date` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-12-05  1:06:33
